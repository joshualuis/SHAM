    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-content">
              <form id="addSubs" action="/admin/curriculums" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="description" class="control-label">Description<star>*</star></label>
                        <textarea type="text" class="form-control" placeholder="description" id="description" name="description" value="{{old('description')}}" required></textarea>
  ...
  function showSwal(type) {
    ...
    if (validateForm()) {
      if (type == 'warning-message-and-cancel') {
        swal({
          title: 'New Subject',
          text: 'Would you like to add a new subject?',
          type: 'warning',
          ...
          if (result.value) {
            document.getElementById('addSubs').submit();
            swal({
            title: 'New Subject Created',
            text: 'A new subject record is successfully added!',
            type: 'success',
            confirmButtonClass: "btn btn-success btn-fill",
            buttonsStyling: false
            })
