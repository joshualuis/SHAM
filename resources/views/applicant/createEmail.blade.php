	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header">
	                                <h4 class="card-title">Set an interview</h4>
	                                <p class="category"></p>
	                            </div>

                              <div class="card-content">
                              <form id="sendEmail" action="/admin/applicants/emailing" method="POST">
                                  @csrf
                                  <div class="row">
                                      <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                      <div class="card">
                        <div class="card-header">
                          ...
                          <p class="category">Please ensure you are sending interview schedule for eligible applicants.</p>
                        </div>
