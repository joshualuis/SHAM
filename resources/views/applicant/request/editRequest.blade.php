	...
	<div class="row">
      ...
      <div class="card">
	      <div class="card-header">
	        <h4 class="card-title">Resched Interview</h4>
          <p class="category"></p>
	      </div>
	      
        <div class="card-content">
          {{ Form::model($applicant,['method'=>'PATCH','route' => ['applicant.updateRequest', $applicant->_id, 'files' => true], 'id' => 'applicantEdit']) }}
            @csrf
            <div class="row">

                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="control-label">Unaattended Date & Time<star>*</star></label>
                    {{ Form::datetimeLocal('intDate', $dateTime, array('class'=>'form-control','id'=>'intDate', 'disabled'=>'true')) }}
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$applicant->reschedReason}}" disabled>
                  </div>
                </div>

                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="control-label">Rescheduled Date & Time<star>*</star></label>
                    {{ Form::datetimeLocal('reschedInt', null, array('class'=>'form-control','id'=>'intDate', 'required'=>'true')) }}
                  </div>
                </div>
