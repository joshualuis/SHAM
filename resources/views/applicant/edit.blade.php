	...
	<div class="row">
      ...
      <div class="card">
        ...
        <div class="card-content">
          {{ Form::model($applicant,['method'=>'PATCH','route' => ['applicants.update', $applicant->_id, 'files' => true], 'id' => 'applicantEdit']) }}
            @csrf
            <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    {{ Form::datetimeLocal('intDate', $date, array('class'=>'form-control','id'=>'intDate', 'required'=>'true')) }}
                  </div>
                </div>
