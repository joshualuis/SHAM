...
<html>
  ...
  <body>
    <div class="left-card">
                ...
                <tbody>
                    ...
                    @endforeach
                        <tr>
                            <td style="padding:3px;" class="right" colspan="4"><b>General Average for the Semester<b></td>
                            @if($a['secondGWA'] != 0)
                                <td class="center">{{$a['secondGWA']}}</td>
                            @else
                                <td></td>
                            @endif
                            <td></td>
        ...
        @else
        <label class="underlinegenave" for="genave" style="padding-top: 10px; margin-left: 216px; font-family: 'Open Sans', sans-serif; font-size: 12px; font-style:bold; text-align: center;  display: inline-block;">{{$a['syGWA']}}</label>
        @endif
	...
	<div class="right-card">
        <div style="float:left; margin-left:25px; margin-top:45px;">
            <img src="<?php echo $a['pic1'] ?>" style="width:70px;">
        </div>
        <div style="float:right; margin-right:25px; margin-top:45px;">
            <img src="<?php echo $a['pic2'] ?>" style="width:70px;">
        </div>
        ...
        <div style="text-align: center;">
            ...
            <label for="sy" style="font-family: 'Serif', Times New Roman; font-size: 13px; text-align: center; padding-top: 10px; display: inline-block; text-decoration: underline;">{{$a['year']->year}}</label><br>
        </div>
        ...
        <label class="underlinename" for="fullname" style="font-family: 'Open Sans', sans-serif; font-size: 13px; font-style:bold; padding-left: 10px; padding-top: 10px; display: inline-block;">{{$a['student']->fullname}}</label><br>
        ...
        <label class="underlinelrn" for="lrn" style="font-family: 'Open Sans', sans-serif; font-size: 13px; font-style:bold; text-align: center; padding-left: 10px; display: inline-block;">{{$a['student']->lrn}}</label>
        
        <label for="sex" style="font-family: 'Open Sans', sans-serif; font-size: 13px; font-style:bold; display: inline-block;">SEX:</label>
        <label class="underlinesex" for="sex" style="font-family: 'Open Sans', sans-serif; font-size: 13px; font-style:bold; text-align: center;  display: inline-block; ">{{$a['student']->gender}}</label>
        
        <label for="age" style="font-family: 'Open Sans', sans-serif; font-size: 13px; font-style:bold; display: inline-block;">AGE:</label>
        <label class="underlineage" for="age" style="font-family: 'Open Sans', sans-serif; font-size: 13px; font-style:bold; text-align: center;  display: inline-block; ">{{$a['student']->age}}</label>
        <br>
        ...
        <label class="underlinegrade" for="grade" style="font-family: 'Open Sans', sans-serif; font-size: 13px; font-style:bold; text-align: center;  display: inline-block; ">{{$a['student']->section->glevel}}</label>
        ...
        <label class="underlinesection" for="section" style="font-family: 'Open Sans', sans-serif; font-size: 13px; font-style:bold; text-align: center;  display: inline-block; ">{{$a['student']->section->name}}</label>
        <br>
        ...
        <label class="underlinets" for="ts" style="font-family: 'Open Sans', sans-serif; font-size: 12px; font-style:bold; display: inline-block; ">{{$a['student']->strand->track}} / {{$a['student']->strand->name}}</label>
        ...
        <div class="namecontainer">
            <div class="nameleft">
                <h5 class="center" style="font-family: 'Open Sans', sans-serif; font-size: 13px; font-style:bold; text-decoration: underline; padding-top: 10px;">{{$a['year']->principal}}</h5>
                <h5 class="center" style=" font-size: 12px; font-style:normal;"><em>{{$a['year']->titlex }}</em></h5>
            </div>

            <div class="nameright">
                <h5 class="center" style="font-family: 'Open Sans', sans-serif; font-size: 13px; font-style:bold; text-decoration: underline; padding-top: 10px;">{{$a['adviser']}}</h5>
                    ...
                    <table class="attendancetable" style="margin-left: 20px; font-family: 'Open Sans', sans-serif;">
                            <thead>
                                <tr>
                                    ...
                                    @foreach($a['userArr'] as $month => $num)
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    @endforeach
                                    <td style="text-align: center;">{{$a['totalAll']}}</td>
                                </tr>
                                <tr>
        ...
        <div>
            ...
            <div class="namecontainer">
                <div class="nameleft">
                    <h5 class="center" style="font-family: 'Open Sans', sans-serif; font-size: 13px; font-style:bold; text-decoration: underline; padding-top: 10px;">{{$a['year']->principal}}</h5>
                    <h5 class="center" style=" font-size: 12px; font-style:normal;"><em>{{$a['year']->title}}</em></h5>
                </div>
